...
return IexecOracle.at("0xd95a36bb3c67bbb6f50be1087cfe2bdbf498da16")
      .then(instance => {
        aIexecOracleInstance = instance;
return aIexecOracleInstance.getWork.call('0x3eee7ee324513784e17fbd139ad639e5ba9357d8974cf07375c77ace7c078668');
      }).then(getWorkCall => {
      [timestamp,status,stdout,stderr, uri] =getWorkCall;
