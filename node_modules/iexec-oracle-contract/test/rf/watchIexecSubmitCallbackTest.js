var IexecOracleAPIimpl = artifacts.require("./IexecOracleAPIimpl");
...
contract('IexecOracleAPIimpl', function(accounts) {
  ...
  it("watch CallbackEvent", function() {
    var aIexecOracleAPIimplInstance;
return IexecOracleAPIimpl.at("0x52fee0fa012a3ad38d8436d0af947ee1c5bd952c")
      .then(instance => {
    aIexecOracleAPIimplInstance = instance;
        return Extensions.getEventsPromise(aIexecOracleAPIimplInstance.IexecSubmitCallback({}, {
          fromBlock: 0,
          toBlock: "latest"
        }));
      }).then(events => {
